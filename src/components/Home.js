           ...
           <div className="home-components row">
                <div className="col-12 col-md-8">
                    <div className="me-md-5">
                        ...
                        <p>
                        በየጎዳና የወደቁ የአዕምሮ ህሙማን ወገኖቻችንን ከጎዳና በማንሳት መጀመሪያ ገላቸው በማጠብ ልብሳቸውን በመቀየር ህክምና ክትትል እንዲያደርጉ በማድረግ ምግባቸውን መኝታቸውን በማመቻቸት ተገቢውን ድጋፍ ፍቅር በመሰጠት ጤናቸውን ወሰተሻለ ደረጃ እንዲደርስ ማስቻል በክትትሉም ለውጥ ያመጡ የዳኑ ሰዎችን የተለያዩ ስልጠና እንዲያገኙ በማድረግ ወደ ማህበረሰቡ እንዲቀላቀሉ ማገዝ ህይወታቸው የተሻለ የተሳካ እንዲሆን እገዛ ድጋፍ ማድረግ፡፡ 
                        ጧሪ ቀባሪ የሌላቸው አዛውንቶችን የሀገር ባለውለታዎችን ከወደቁበት በማንሳት ቀሪ ዘመናቸውን በተረጋጋ ሁኔታ ያለ ስጋት ይኖሩ ዘንድ ህክምና ክትትላቸውን እያደረጉ እንክብካቤ ፍቅርን በመስጠት ቀሪ ዘመናቸውን በነጻነት እንዲኖሩ ማስቻል፡፡
                ...
                <div className="col-md-4 col-12 home-box">
                    ...
                    <div className="home-box-text">
                        <p>-ኑ! ማህበሩን ጎብኙልን</p>
                        <p>-ኑ! ለህሙማን ፍቅር እና እንክብካቤ እንስጣቸው</p>
                        <p>-ኑ! ልብሳቸውን እና ገላቸውን እንጠብ</p>
                        <p>-ኑ! ፍቅር በመስጠት ከገቡበት የጤና መጉደል እንታደጋቸው  </p>
