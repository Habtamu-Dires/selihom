        ...
        <div className="container">
                <div className="row">
                    ...
                    <div className="col-12">
                        <h4>ሰሊሆም የአዕምሮ ህሙማን መርጃ ማህበር</h4>
                        <hr />
                    </div>                
                </div>
                <div className="row">
